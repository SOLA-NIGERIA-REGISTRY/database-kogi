...
UPDATE source.administrative_source_type SET status = 'x' WHERE code IN ('courtOrder', 'mortgage', 'powerOfAttorney', 'proclamation', 'will', 'caveat', 'personPhoto', 'taxPayment', 'utilityBill', 'lease', 'deed', 'officeNote', 'other',
'requisition', 'agreement', 'contractForSale', 'relationshipTitle', 'pdf', 'title', 'idVerification', 'waiver', 'cadastralSurvey', 'cadastralMap', 'agriConsent', 'tiff', 'jpg', 'agriLease', 'tif', 'publicNotification', 
'restrictionOrder', 'parcelPlan', 'standardDocument', 'surveyDataFile', 'systematicRegn', 'objection', 'agriNotaryStatement');
